...
type VerifyCodePhoneRequest struct {
	CaptchaID string `json:"captcha_id,omitempty" form:"captcha_id" valid:"captcha_id"`
	CaptchaAnswer string `json:"captcha_answer,omitempty" form:"captcha_answer" valid:"captcha_answer"`
